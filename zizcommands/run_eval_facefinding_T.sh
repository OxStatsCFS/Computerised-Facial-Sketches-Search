...
# Usage: `sbatch /data/ziz/not-backed-up/haliu/idad/zizcommands/run_eval_facefinding_T.sh`
...
echo 'Job started.'
python3 eval_facefinding_T.py \
    --experiment-id 1 \
    --device cpu \
    --run-id 027c0d4fe54749b18ff1d835ffb190c3 \
    --T-deploy 121 \
    --n-trace 2
echo "Job completed." 