...
# Usage: `sbatch /data/ziz/not-backed-up/haliu/idad/zizcommands/run_eval_sPCE_from_source.sh`
...
#SBATCH --job-name=evalsPCEsource
...
#NOTSBATCH --gres=gpu:GeForce_GTX_2080:1  # use 1 GPU
...
python3 eval_sPCE_from_source.py \
    --path-to-artifact ./mlruns/1/a857a918e7d34f3ba86bc2845cbf25ba \
